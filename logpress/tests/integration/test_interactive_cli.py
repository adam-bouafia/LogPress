...
class TestInteractiveCLIWorkflow:
    ...
    @patch('logpress.cli.interactive.Console')
    @patch('logpress.cli.interactive.Prompt')
    ...
    @patch('logpress.cli.interactive.Confirm')
    @patch('logpress.cli.interactive.Console')
    def test_dataset_selection_flow(self, mock_console, mock_confirm, 
        ...
        # We're testing the selection logpress only
        selected = []
