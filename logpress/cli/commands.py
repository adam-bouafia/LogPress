...
def compress(input, output, measure, min_support):
    ...
    Example:
        logpress compress -i datasets/Apache/Apache_full.log -o compressed/apache.lsc -m
    """
    import time
...
def query(compressed, severity, ip, limit):
    ...
    Example:
        logpress query -c compressed/apache.lsc --severity ERROR --limit 20
    """
